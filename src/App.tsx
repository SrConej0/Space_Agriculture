...
function App() {
  ...
  const { gameState, daysInStage, isProcessing, handleAction } = useGameLogic();
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-blue-900/10 to-gray-900 relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        {gameState.stage === 5 && (
          <div className="mt-8 bg-gradient-to-br from-green-900/90 to-green-800/90 backdrop-blur-sm border-2 border-green-500/50 rounded-lg p-6 shadow-2xl text-center animate-slideUp">
            <h2 className="text-3xl font-bold text-green-400 mb-4">Mission Complete!</h2>
            <p className="text-gray-300 text-lg mb-4">
              You have successfully completed the full growth cycle using sustainable practices.
            </p>
            <p className="text-2xl font-bold text-yellow-400">
              Final Score: {gameState.score}
            </p>
            <p className="text-gray-400 mt-2">
              Your knowledge of sustainable agriculture will help feed humanity in 2050 and beyond.
            </p>
          </div>
        )}
      </div>
